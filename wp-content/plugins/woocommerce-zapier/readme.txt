...
Important installation and configuration instructions are [available here](https://docs.woocommerce.com/document/woocommerce-zapier/).
...
Please [consult the documentation](https://docs.woocommerce.com/document/woocommerce-zapier/), or [contact support](https://woocommerce.com/my-account/create-a-ticket/).
