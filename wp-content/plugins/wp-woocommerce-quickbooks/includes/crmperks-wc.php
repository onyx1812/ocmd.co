...
public function add_meta_box(){
    ...
    add_meta_box(
            'vx-user-info', //$id
            __( 'Marketing Data','wp-woocommerce-quickbooks' ), //$title
...
<p><?php _e('Need Marketing Insight? ,','wp-woocommerce-quickbooks')?> <a href="<?php echo $plugin_url ?>&section=vxc_premium"><?php _e('Go Pro!','wp-woocommerce-quickbooks')?></a></p>
</div>
 <?php
 return;
 }
...
if(!$html_added){
   ?> 
   <h3 style="text-align: center;"><?php _e('No Information Available','wp-woocommerce-quickbooks')?></h3>
   <?php
return;
}
