...
<div class="crm_head_div"><span class="crm_head_text"><?php _e('Data Sent','wp-woocommerce-quickbooks') ?></span></div>
...
<?php
      ...
      ?>
  <div class="vx_error"><i class="fa fa-warning"></i> <?php _e('Nothing Posted to QuickBooks','wp-woocommerce-quickbooks');?></div>      
      <?php
  }
?>
</div></div>
...
if(is_array($response) && count($response)>0){
      ...
      ?>
        <div class="crm_panel crm_panel_50">
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php _e('QuickBooks Response','wp-woocommerce-quickbooks'); ?></span></div>
<div class="crm_btn_div"><i class="fa crm_toggle_btn fa-minus" title="<?php _e('Expand / Collapse','wp-woocommerce-quickbooks'); ?>"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php _e('More Detail','wp-woocommerce-quickbooks') ?></span></div>
<div class="crm_btn_div"><i class="fa crm_toggle_btn fa-minus" title="<?php _e('Expand / Collapse','wp-woocommerce-quickbooks'); ?>"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
<?php
    if($log['feed_id']!=""){
?>
<a href="<?php echo add_query_arg(array('post'=>$log['feed_id'],'action'=>'edit'), admin_url('post.php')); ?>" title="<?php _e('Edit Feed','wp-woocommerce-quickbooks') ?>" class="button"><i class="fa fa-edit"></i> <?php _e('Edit Feed','wp-woocommerce-quickbooks') ?></a>
<?php
    }
?>
<a href="<?php echo admin_url( 'admin.php?page='.$this->id.'_log&id='.$log['id']); ?>" title="<?php _e('Open in New Window','wp-woocommerce-quickbooks') ?>" target="_blank" class="button"><i class="fa fa-external-link"></i> <?php _e('Open in New Window','wp-woocommerce-quickbooks') ?></a>
<a href="#" class="button vx_close_detail" title="<?php _e('Close','wp-woocommerce-quickbooks') ?>"><i class="fa fa-times"></i> <?php _e('Close','wp-woocommerce-quickbooks') ?></a>
