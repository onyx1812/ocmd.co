...
?>
    <div class="wrap" id="wffn_oty_edit_vue_wrap">
        ...
        <div class="bwf_breadcrumb">
            ...
            <div class="bwf_after_bre">
                <a v-on:click="updateOty()" href="javascript:void(0);" class="bwf_edt">
		...
		<?php WFOPP_Core()->optin_ty_pages->admin->get_tabs_html( WFOPP_Core()->optin_ty_pages->get_edit_id() ); ?>
