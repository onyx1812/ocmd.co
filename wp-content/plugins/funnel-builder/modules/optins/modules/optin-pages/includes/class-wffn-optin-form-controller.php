...
abstract class WFFN_Optin_Form_Controller {
	 ...
	 * @return array
	 */
	public function get_all_active_forms( $page_id = 0 ) {
		return [];
	}
	 ...
	 * @return array
	 */
	public function get_forms_fields( $page_id, $form_id ) {
		return array( 0 => __( 'Select a field', 'funnel-builder' ) );
	}
	 ...
	 * @return array
	 */
	public function create_new_form( $formTitle, $page_id = 0 ) {
		return [];
	}
	 ...
	 * @return string
	 */
	public function get_form_edit_link( $form_id, $page_id = 0 ) {
	...
	/**
	 * Returning title of selected form
	 *
	 * @param $form_id
	 * @param $optinPageId
	 *
	 * @return string|void
	 */
	public function get_form_title( $form_id, $optinPageId ) {
		$form_post = get_post( $form_id );
		if ( $form_post instanceof WP_Post ) {
			return $form_post->post_title;
		}

		return __( 'Form title', 'funnel-builder' );
	}
