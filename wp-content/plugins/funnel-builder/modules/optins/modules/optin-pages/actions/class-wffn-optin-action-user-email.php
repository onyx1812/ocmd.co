...
class WFFN_Optin_Action_User_Email extends WFFN_Optin_Action {
	...
	public function handle_action( $posted_data, $fields_settings, $optin_action_settings ) {
		...
		$this->trigger_email( $optin_email, $option['lead_notification_subject'], $db_options['op_user_name'], $db_options['op_user_email'], $db_options['op_user_email_reply'], $content );
	...
	public function test_email( $option ) {
		...
		$result   = $this->trigger_email( $optin_email, $option['lead_notification_subject'], $db_options['op_user_name'], $db_options['op_user_email'], $db_options['op_user_email_reply'], $content );
