...
class Elementor_WFFN_Optin_Form_Widget extends \Elementor\Widget_Base {
	...
	public function register_sections() {
		...
		$this->add_text( 'button_text', __( 'Title', 'funnel-builder' ), __( 'Signup Now', 'funnel-builder' ), [], '', '', __( 'Enter the Button Text', 'funnel-builder' ) );
	...
	public function register_styles() {
		...
		$this->add_background_color( 'button_bg_color', [ '{{WRAPPER}} .bwfac_form_sec #wffn_custom_optin_submit' ], '#26b453' );
		...
		$this->add_background_color( 'button_hover_bg_color', [ '{{WRAPPER}} .bwfac_form_sec #wffn_custom_optin_submit:hover' ], '#0a6c2f' );
	...
	public function add_icon( $field_key, $selectors, $label = "", $default = '' ) {
		if ( empty( $label ) ) {
	...
	public function add_icon_position( $field_key, $selectors, $label = "", $default = '' ) {
		if ( empty( $label ) ) {
