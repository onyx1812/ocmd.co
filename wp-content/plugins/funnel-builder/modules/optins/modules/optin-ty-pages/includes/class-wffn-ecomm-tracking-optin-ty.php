 ...
 * @author woofunnels.
 */
class WFFN_Ecomm_Tracking_Optin_Ty {
	...
	public function render_fb_view() {
		if ( $this->do_track_fb_view() && WFOPP_Core()->optin_ty_pages->is_wfoty_page() ) {
			?>
			fbq('track', 'PageView');
			<?php
		}
	...
	public function ga_code() {
		$get_ga_key = apply_filters( 'bwf_get_ga_oty_key', $this->admin_general_settings->get_option( 'ga_key' ) );
	...
	public function should_render() {
		if ( WFOPP_Core()->optin_ty_pages->is_wfoty_page() ) {
			return true;
		}
