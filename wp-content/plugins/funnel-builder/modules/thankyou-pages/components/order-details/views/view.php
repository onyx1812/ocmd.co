	...
	switch ( $item ) {
		case 'order_details':
            ...
            <div class="wfty_box wfty_order_details">
				...
				$get_meta    = get_post_meta( $this->order->get_id(), '_wfocu_sibling_order', false ); //phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UndefinedVariable
                        ...
                        <div class="wfty_pro_list_cont <?php echo esc_attr( $show_images_class ); ?>">
                            ...
                            <table>
								...
								foreach ( $item_total as $total ) {
									?>
                                    <tr>
                                        <th scope="row"><?php esc_html_e( $total['label'], 'funnel-builder' ); ?></th>
...
do_action( 'wfty_woocommerce_order_details_after_order_table', $order_obj );
