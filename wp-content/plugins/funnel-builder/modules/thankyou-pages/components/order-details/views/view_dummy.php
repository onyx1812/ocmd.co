...
$order_details_heading = isset( $this->data['order_details_heading'] ) ? $this->data['order_details_heading'] : __( 'Order Details', 'funnel-builder' ); //phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UndefinedVariable
$show_images_class     = ( $order_show_images ) ? 'wfty_show_images' : 'wfty_hide_images';
$price                 = 51.15;
$subscription_price    = 7.50;
$order_subscription_heading   = ( isset( $this->data['order_subscription_heading'] ) && ! empty( $this->data['order_subscription_heading'] ) ) ? $this->data['order_subscription_heading'] : esc_html__( 'Subscription', 'woocommerce' ); //phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UndefinedVariable
            ...
            <div class="wfty_box wfty_order_details">
                ...
                <div class="wfty_pro_list_cont <?php echo esc_attr( $show_images_class ) ?>">
                    ...
                    <table>
                        <tfoot>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Subtotal:', 'funnel-builder' ); ?></th>
						...
						if ( 'disabled' !== $shipping_option ) {
							...
							?>
                            <tr>
                                <th scope="row"><?php esc_html_e( 'Shipping:', 'funnel-builder' ); ?></th>
                                <td>
						<span class="woocommerce-Price-amount amount"><?php echo wp_kses_post( wc_price( 17.85 ) ); ?>&nbsp;<small class="shipped_via"><?php esc_html_e( 'via Local pickup', 'funnel-builder' ); ?></small>
                                </td>
                            </tr>
						<?php } ?>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Payment method:', 'funnel-builder' ); ?></th>
                            <td><?php esc_html_e( 'Credit Card', 'funnel-builder' ); ?></td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Total:', 'funnel-builder' ); ?></th>
                            <td><?php echo wp_kses_post( wc_price( $price ) ); ?></td>
                        </tr>
                        </tfoot>
                    </table>
                ...
                <table class="shop_table shop_table_responsive wfty_order_downloads">
					...
					$downloads = array(
						array(
							...
							'download_name'       => 'Your_downloadable_file.pdf',
            ...
            <div class="wfty_box wfty_subscription">
                ...
                <table class="shop_table shop_table_responsive my_account_orders">
                    ...
                    <tr>
                        ...
                        <th class="order-total wfty_center "><span class="nobr"><?php echo esc_html_x( 'Action', 'table heading', 'woocommerce-subscriptions' ); ?></span></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr class="order">
                        <td data-title="Subscription" class="subscription-id order-number wfty_left">
                            ...
                            <small>( <?php esc_html_e( 'Active', 'funnel-builder' ); ?>)</small>
                        </td>
                        <td data-title="Next Payment" class="subscription-next-payment order-date wfty_center "> <?php esc_html_e( 'In 24 hours', 'funnel-builder' ); ?></td>
                        <td data-title="Total" class="subscription-total order-total wfty_center "> <?php echo wp_kses_post( wc_price( $subscription_price ) ); ?>
                            /<?php esc_html_e( 'day', 'funnel-builder' ); ?></td>
...
do_action( 'wfty_woocommerce_order_details_after_order_table' );
?>
