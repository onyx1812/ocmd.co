...
class Elementor_WFTY_Order_Details_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control( 'product_text_color', [
			...
			'selectors' => [
			    '{{WRSPPER}} .elementor-order-details-wrapper .wffn_order_details_table .wfty_pro_list_cont'                                                                                                   => 'border-bottom: none',
				'{{WRAPPER}} .elementor-order-details-wrapper .wffn_order_details_table .wfty_pro_list_cont .wfty_pro_list *'                                                                                  => 'color: {{VALUE}}',
				'{{WRAPPER}} .elementor-order-details-wrapper .wfty_wrap table.my_account_orders td, {{WRAPPER}} .elementor-order-details-wrapper .wfty_wrap table.my_account_orders th'                       => 'text-align: left;',
				'{{WRAPPER}} .elementor-order-details-wrapper .wfty_wrap table.shop_table_responsive td:last-child, {{WRAPPER}} .elementor-order-details-wrapper .wfty_wrap table.shop_table_responsive th:last-child' => 'text-align: right;',
				'{{WRAPPER}} .elementor-order-details-wrapper .wfty_quantity strong'                                                                                                                           => 'display: none;',
				'{{WRAPPER}} .elementor-order-details-wrapper .wfty_pro_list_cont .wfty_pro_list .wfty_quantity_value_box'                                                                                     => 'color: #fff; font-size: 13px;',
        ...
        $this->add_control( 'subscription_text_color', [
            ...
            'selectors' => [
                ...
                '{{WRAPPER}} .elementor-order-details-wrapper .wffn_order_details_table .wfty_wrap .wfty_subscription table tr td.subscription-actions a'                                                                                                                                                                                                                         => 'padding: 5px 10px;display: inline;text-transform: none;border-radius:unset;border:none;margin-right:0;',
                'body {{WRAPPER}} .elementor-order-details-wrapper .wffn_order_details_table .wfty_wrap .wfty_subscription table tr th, body {{WRAPPER}} .elementor-order-details-wrapper .wffn_order_details_table .wfty_wrap .wfty_subscription table tr td'                                                                                                                    => 'padding: 10px; border: none;text-transform: none;background: transparent;',
            ],
        ] );
		...
		$this->add_control( 'text_color', [
			...
			'selectors' => [
				...
				'{{WRAPPER}} .elementor-order-details-wrapper .wfty_wrap table.wfty_order_downloads tr td.download-file a'                                                                           => 'padding: 5px 10px;display: block;margin-right: 0;text-align: center; text-transform: inherit',
				'{{WRAPPER}} .elementor-order-details-wrapper .wfty_wrap .wfty_order_downloads'                                                                                                      => 'width: 100%;',
				'{{WRAPPER}} .elementor-order-details-wrapper .wfty_wrap .wfty_order_downloads tr td.download-product'                                                                               => 'word-break: break-word;',
				'{{WRAPPER}} .elementor-order-details-wrapper .wfty_wrap table.wfty_order_downloads tr th, {{WRAPPER}} .elementor-order-details-wrapper .wfty_wrap table.wfty_order_downloads tr td' => 'padding: 10px; border: none; text-transform: none;background: transparent;',
			],
		] );
	...
	protected function render() {
		...
		$show_column_download    = empty( $settings['order_downloads_show_file_downloads'] ) ? 'false' : 'true';
		$show_column_file_expiry = empty( $settings['order_downloads_show_file_expiry'] ) ? 'false' : 'true';
