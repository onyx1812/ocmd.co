                        ...
                        <div class="wfacp_temp_overlay">
                            <div class="wfacp_temp_middle_align">
                                ...
                                <div class="wfacp_p wfacp_import_template" v-on:click="triggerImport(template,slug,type,$event)">
                                    <span class="dashicons dashicons-update"></span><span class="wfacp_import_text"><?php _e( 'Build from scratch', 'woofunnels-aero-checkout' ); ?></span><span class="wfacp_importing_text"><?php _e( 'Importing...', 'woofunnels-aero-checkout' ) ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="wfacp_temp_overlay">
                            <div class="wfacp_temp_middle_align">
                                <div class="wfacp_pro_template" v-if="template.pro && `no` === template.license_exist">
                                    ...
                                    <a target="_blank" href="<?php echo esc_url( 'https://buildwoofunnels.com/exclusive-offer/' ) ?>" class="wfacp_steps_btn wfacp_steps_btn_danger"><?php _e( 'Get PRO', 'woofunnels-aero-checkout' ) ?></a>
                                </div>
                                <div class="wfacp_pro_template" v-else>
                                    <a class="wfacp_btn_white wfacp_display_block">{{template.name}}</a>
                                    <a v-bind:href="template.preview_url" target="_blank" class="wfacp_steps_btn wfacp_steps_btn_success"><?php _e( 'Preview', 'woofunnels-aero-checkout' ) ?></a>
                                    <a href="javascript:void(0)" class="wfacp_steps_btn wfacp_import_template wfacp_steps_btn_green" v-on:click="triggerImport(template,slug,type,$event)"><span class="dashicons dashicons-update"></span><span class="wfacp_import_text"><?php _e( 'Import', 'woofunnels-aero-checkout' ) ?></span><span class="wfacp_importing_text"><?php _e( 'Importing...', 'woofunnels-aero-checkout' ) ?></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
