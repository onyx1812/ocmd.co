        ...
        <div class="wfacp_wrap_inner wfacp_wrap_inner_offers">
            <div class="wfacp-product-tabs-view-vertical wfacp-product-widget-tabs">
                <div class="wfacp-product-tabs-wrapper wfacp-tab-center ">
                    <div id="wfacp-global-checkout" data-tab="1" role="tab" class="wfacp-tab-title wfacp-tab-desktop-title wfacp_tracking_analytics"><?php esc_html_e( 'Tracking Analytics', 'woofunnels-aero-checkout' ) ?></div>
                                ...
                                <div class="wfacp_global_container">
                                    <form @change="changed()" v-on:submit.prevent="save()">
                                        ...
                                        <div class="bwf_ajax_save_buttons bwf_form_submit">
                                            ...
                                            <button type="submit" class="wfacp_save_btn_style" style=" margin-bottom: 10px;width: 110px"><?php esc_html_e( 'Save changes', 'woofunnels-aero-checkout' ); ?></button>
                                        </div>
                                        <br/>
                                    </form>
                                </div>
