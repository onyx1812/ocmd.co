	...
	public function internal_css( $selected_template_slug ) {
        ...
        <style>
            ...
            @media (min-width: 768px) {
                .wfacp_main_form.woocommerce form .form-row-third:not(.wfacp-draggable):not(.wfacp-col-left-third) {
                    margin-right: 0;
                    width: 33.33%;
                    float: left;
                    clear:none;
                ...
                body .wfacp_main_form.woocommerce p.form-row:not(.wfacp-draggable).wfacp_house_number,
                body .wfacp_main_form.woocommerce p.form-row:not(.wfacp-draggable).wfacp_house_number_suffix {
                    width: 33.33%;
                    float: left;
                }
            }
