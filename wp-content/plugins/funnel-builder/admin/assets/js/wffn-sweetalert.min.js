/*!
* wffn_Sweetalert2 v7.19.1
* Released under the MIT License.
*/
(function (e, t) {
    'object' == typeof exports && 'undefined' != typeof module ? module.exports = t() : 'function' == typeof define && define.amd ? define(t) : e.wffn_Sweetalert2 = t()
})(this, function () {
    'use strict';
    ...
    function n(e) {
        ...
        ae(e.footer, g), !0 === e.animation ? T(t, B.noanimation) : O(t, B.noanimation), e.showLoaderOnConfirm && !e.preConfirm && h('showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://wffn_Sweetalert2.github.io/#ajax-request')
    }

    function o() {
        if ('undefined' != typeof window) {
            'undefined' == typeof Promise && b('This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/wffn_Sweetalert2/wffn_Sweetalert2/wiki/Migration-from-SweetAlert-to-wffn_Sweetalert2#1-ie-support)');
            for (var e = arguments.length, t = Array(e), n = 0; n < e; n++) t[n] = arguments[n];
            if ('undefined' == typeof t[0]) return b('wffn_Sweetalert2 expects at least 1 attribute!'), !1;
            i = this;
    ...
    var i, a = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ? function (e) {
        ...
        }(), m = 'wffn_Sweetalert2:', g = function (e) {
        ...
        ie = function (e) {
            var t = N();
            if (t && (t.parentNode.removeChild(t), T([document.documentElement, document.body], [B['no-backdrop'], B['has-input'], B['toast-shown']])), ne()) return void b('wffn_Sweetalert2 requires document to initialize');
        ...
        var t = function (t) {
            ...
            return u(n, t), s(n, [{
                ...
                key: 'setDefaults', value: function (t) {
                    if (v(ve), !t || 'object' !== ('undefined' == typeof t ? 'undefined' : a(t))) throw new TypeError('wffn_Sweetalert2: The argument for setDefaults() is required and has to be a object');
...
}), 'undefined' != typeof window && window.wffn_Sweetalert2 && (window.wffn_swal = window.wffn_Sweetalert2);
