...
<div class="wrap wffn-funnel-common">
	...
	<?php WFFN_Core()->thank_you_pages->admin->render_primary_nav(); ?>
    <h1 class="wp-heading-inline"><?php esc_html_e( 'Settings', 'funnel-builder' ); ?></h1>
	<?php
	$admin_settings = BWF_Admin_Settings::get_instance();
	$admin_settings->render_tab_html( 'ty-settings' );
	$class = "";
	if ( defined( 'WFOCU_VERSION' ) ) {
		$class = "hide_bwf_btn";
	}
	?>

    <div id="wffn_ty_settings_vue_wrap" class="wffn-tabs-view-vertical wffn-widget-tabs">

        <div class="wffn-tabs-wrapper wffn-tab-center">
            <div class="wffn-tab-title wffn-tab-desktop-title description_tab <?php echo esc_attr( $class ); ?>" id="tab-title-description" data-tab="1" role="tab"
                 aria-controls="wffn-tab-content-description">
				<?php esc_html_e( 'Tracking & Analytics', 'funnel-builder' ); ?>
            </div>
            ...
            <div class="wffn-tab-title wffn-tab-desktop-title additional_information_tab wffn-active" id="tab-title-additional_information" data-tab="3" role="tab" aria-controls="wffn-tab-content-additional_information">
