...
EOF;
	...
	public function get_plugin_settings_post_data(){
		...
		//
		'mw_wc_qbo_sync_produc_push_purchase_desc_field' => isset($_POST['mw_wc_qbo_sync_produc_push_purchase_desc_field'])?$_POST['mw_wc_qbo_sync_produc_push_purchase_desc_field']:'',
