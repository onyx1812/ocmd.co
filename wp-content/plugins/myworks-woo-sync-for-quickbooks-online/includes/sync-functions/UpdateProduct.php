	...
	if($this->is_connected()){
		...
		if($wc_product_id && $this->if_sync_product($wc_product_id)){
			...
			*/
			...
			//
			if(isset($product_data['wholesale_customer_wholesale_price']) && $this->is_only_plugin_active('woocommerce-wholesale-prices','woocommerce-wholesale-prices.bootstrap')){
			...
			*/
			...
			if($purchase_desc_field=='short_description'){
				$purchase_desc = $this->get_array_isset($product_data,'short_description','',true,4000);
			}elseif($purchase_desc_field=='name'){
				$purchase_desc = $name;
			}else{
				//$purchase_desc = $this->get_array_isset($product_data,'description','',true,4000);
			}
