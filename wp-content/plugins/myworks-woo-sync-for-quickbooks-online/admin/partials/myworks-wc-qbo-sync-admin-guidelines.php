...
function __mwqbo_push_page_guide(){
  ...
  elseif($tab=='payment'){
    $HTML = '<div class="guide">
            In this tab, you can select and push payments from <a target="_blank" href="https://myworks.software/integrations/sync-woocommerce-quickbooks-online" target="_blank" rel="nofollow noreferrer">﻿WooCommerce to QuickBooks Online﻿</a>. Choose the Filter option to search for a specific customer or date range, and use the dropdown on the top right to display 20 or more entries per page.
            </div>
            <div class="guide">
            Before pushing payments, you should check and verify the mappings in Map > Payment Methods are correct.
            </div>
            <div class="guide">
            Note that <b><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/push-pages#payment-push">an invoice must already exist in QuickBooks Online</b>, or it will error out. 
            </div>';
  }else{
    $HTML = '<div class="guide">
            Need help on this? Please contact our support anytime! 
  ...
  if($tab=='customer'){
    ...
    <li>
      ...
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/mapping">About Mapping</a></li>
        <li><a href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/mapping#before-you-map">Before you map</a></li>
        <li><a href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/what-is-the-auto-mapping-feature-and-how-can-i-use-it#customers">Auto-Mapping Customers</a></li>
    ...
    <li>
      ...
      <ul class="guide-submenu">
        <li><a href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/what-does-mapping-mean-and-why-do-i-have-to-map-my-customers-and-products">What does “Mapping” mean, and why do I have to Map my customers and products?</a></li>
        <li><a href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/customers/what-is-the-auto-mapping-feature-and-how-can-i-use-it">What is the “Auto Mapping” feature, and how can I use it?</a></li>
        <li><a href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/how-are-mappings-handled-on-an-ongoing-basis">How are mappings handled on an ongoing basis?</a></li>
      </ul>
    </li>
    ...
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/mapping#payment-gateway-mapping">Mapping payment gateways</a></li>
    ...
    <li>
      <div class="acco-link">Common Questions</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/how-are-mappings-handled-on-an-ongoing-basis">How are mappings handled on an ongoing basis?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/payments/transaction-fee-syncing">How can I handle transaction fees?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/payments/handling-transaction-fees-with-paypal">How can I sync transaction fees with PayPal?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/payments/batch-deposit-support-with-stripe">Do you have batch support?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/payments/batch-support-for-pre-existing-orders">How can I handle batch support for existing orders?</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>';
    ...
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/mapping#product-mapping">Product Mapping</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/what-is-the-auto-mapping-feature-and-how-can-i-use-it#products">Auto-Mapping Products</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/products/variation-support">Variation Support</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/products/bundled-product-support">Bundled Product Support</a></li>
    ...
    <li>
      <div class="acco-link">Common Questions</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/customers/what-is-the-auto-mapping-feature-and-how-can-i-use-it#products">How can I use the auto-mapping feature?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/how-are-mappings-handled-on-an-ongoing-basis">How are mappings handled on an ongoing basis?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/products/variation-support#mapping">How can I map my variations?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/products/bundled-product-support#mapping">How can I map bundled products?</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>';
    ...
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/taxes/mapping-taxes-best-practices">Mapping Taxes - Best Practices</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/advanced-topics/mapping-taxes-best-practices#mapping-combined-tax-rates">Mapping Combined Tax Rates</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Common Questions</div>
    ...
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/mapping#shipping-method-mapping">Configuring shipping method mapping</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Common Questions</div>
      <ul class="guide-submenu">
         <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/how-are-mappings-handled-on-an-ongoing-basis">How are mappings handled on an ongoing basis?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/shipping/shipping-as-a-line-item-or-a-subtotal-field">Shipping: As a line item or a subtotal field?</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>';
...
function __mwqbo_push_page_help(){
  ...
  if($tab=='customer'){
    ...
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/push-pages">Intro to pushing</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/push-pages#customers">Pushing customers</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/mapping#customer-mapping">Mapping customers</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Common questions</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/what-does-mapping-mean-and-why-do-i-have-to-map-my-customers-and-products">What does “Mapping” mean, and why do I have to Map my customers and products?</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>';
    ...
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/push-pages#order-push">How to push orders</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Troubleshooting</div>
      <ul class="guide-submenu">
         <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/troubleshooting/error6520-missing-inventory-item-quantity-quantity-required-for-inventory-item">Error:6520 – Missing Inventory Item Quantity, Quantity required for inventory item</a></li>
    ...
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/push-pages#product-push">Pushing Products</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/mapping#product-mapping">Mapping products</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Common Questions</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/products/variation-support">Do you support variations?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/products/bundled-product-support">Do you support bundles?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/inventory/how-can-i-control-if-products-are-synced-to-quickbooks-as-inventory-or-non-inventory">How can I control if products are synced to QuickBooks as Inventory or Non-Inventory?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/what-does-mapping-mean-and-why-do-i-have-to-map-my-customers-and-products">What does “Mapping” mean, and why do I have to Map my customers and products?</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Troubleshooting</div>
      <ul class="guide-submenu">
         <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/troubleshooting/error6430-invalid-account-type-used-invalid-account-type-you-need-to-select-a-different-type-of-account-for-this-transaction">Invalid Account Type</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>';
    ...
    <li>
      <div class="acco-link">Getting started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/inventory/syncing-inventory-with-quickbooks-online">Syncing Inventory with QuickBooks Online</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/push-pages#inventory-levels">Pushing inventory</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Common Questions</div>
    ...
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/push-pages#payments">Pushing payments</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/payments/transaction-fee-syncing">Transaction fee syncing</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Common Questions</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/payments/handling-non-immediate-payment-gateways-cod-wire-transfer">How can I Handle non-immediate payment gateways (COD, Wire Transfer)?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/payments/batch-deposit-support-with-stripe">How can I handle batch support with stripe?</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>';
...
function __mwqbo_settings_page_help(){
  ...
  $HTML = '<ul id="guide-accordion" class="guide-accordion settings default" style="display: block;">
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/settings#default">Configuring default settings</a></li>
    ...
    <li>
      <div class="acco-link">Common Questions</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/settings">What should my default product be?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/shipping/shipping-as-a-line-item-or-a-subtotal-field">Shipping: As a line item or subtotal field?</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>
  ...
  <ul id="guide-accordion" class="guide-accordion settings order" style="display: none;">
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/settings#order">Configuring order settings</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Common Questions</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/should-i-push-woocommerce-orders-as-a-sales-receipt-or-an-invoice">Should I push WooCommerce Orders as Invoices or Sales Receipts?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/orders/handling-syncing-for-orders-not-instantly-paid-cash-on-delivery-bacs-etc">How can I handle syncing for orders not instantly paid?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/how-are-woocommerce-orders-placed-by-guests-synced-to-quickbooks-online">How are WooCommerce Orders Placed by Guests Synced to QuickBooks?</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/what-if-my-woocommerce-order-numbers-already-exist-in-quickbooks-online-as-different-orders">What if my WooCommerce order numbers already exist in QuickBooks Online – as different orders?</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Troubleshooting</div>
      <ul class="guide-submenu">
         <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/common-questions/what-if-my-woocommerce-order-numbers-already-exist-in-quickbooks-online-as-different-orders">Handling duplicate order numbers between WooCommerce and QuickBooks</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>
  ...
  <ul id="guide-accordion" class="guide-accordion settings tax" style="display: none;">
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/settings#tax">Configuring taxes</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Common Questions</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/compatibility-addons/avalara-avatax">Are you compatible with Avalara AvaTax?</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Additional Resources</div>
      <ul class="guide-submenu">
         <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/taxes/mapping-taxes-best-practices">Mapping Taxes</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>
  ...
  <ul id="guide-accordion" class="guide-accordion settings map" style="display: none;">
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/settings#mapping">Configuring mapping settings</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Common Questions</div>
  ...
  <ul id="guide-accordion" class="guide-accordion settings pull" style="display: none;">
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/settings#pull">Configuring pull settings</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>
  ...
  <ul id="guide-accordion" class="guide-accordion settings sync" style="display: none;">
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/how-does-syncing-work-with-our-plugin">About syncing</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/settings#automatic-sync">Configuring automatic sync settings</a></li>
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/getting-started-with-queue-syncing">About queue sync</a></li>
      </ul>
    </li>
    <li>
      <div class="acco-link">Common Questions</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/getting-started-with-queue-syncing#turning-on-queue-syncing">How can I enable queue sync?</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>
  ...
  <ul id="guide-accordion" class="guide-accordion settings misc" style="display: none;">
    <li>
      <div class="acco-link">Getting Started</div>
      <ul class="guide-submenu">
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online/getting-started/settings#miscellaneous">Configuring miscellaneous settings</a></li>
      </ul>
    </li>
    '.__mwqbo_need_help_common().'
  </ul>';
...
function __mwqbo_need_help_common(){
  ...
  $HTML = '<li>
      ...
      <ul class="guide-submenu">
      <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online">View our documentation</a></li>
      <li><a target="_blank" href="https://myworks.design/account/submitticket.php?step=2&deptid=2">Open a support ticket</a></li>
        ...
        <li><a target="_blank" href="https://docs.myworks.software/woocommerce-sync-for-quickbooks-online">Live chat with us</a></li>
      </ul>
    </li>';
    return $HTML;
}
