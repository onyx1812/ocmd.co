					...
					<div class="md-licence">
					   ...
					   <div class="licence-list">
						  <ul>
							 ...
							 <?php if($MSQS_QL->is_plg_lc_p_l() || $MSQS_QL->is_plg_lc_p_g()):?>
							 <li>
								<div class="left-status">
								   Monthly Orders
								</div>
		   ...
		   <div class="cols-md-4 right-row">
			  ...
			  <div class="side-bar dflt">
				 ...
				 <div class="usa-block">
					...
					<div class="Connect-now">
							 <a href="https://myworks.software/account/submitticket.php?step=2&deptid=2" target="_blank" class="CmnBtn">Open Ticket</a>
						  </div>
				 </div>
