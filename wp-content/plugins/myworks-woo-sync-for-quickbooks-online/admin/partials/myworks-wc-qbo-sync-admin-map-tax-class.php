...
$items_per_page = $MSQS_QL->get_item_per_page('',10);
...
if($tax_map_search!=''){
	...
	$whr.=$wpdb->prepare(" AND (`tax_rate_name` LIKE '%%%s%%' OR `tax_rate_class` LIKE '%%%s%%' ) ",$tax_map_search,$tax_map_search);
						...
						<div class="col s12 m12 l12">
							<div class="myworks-wc-qbo-sync-table-responsive">
								<table class="mw-qbo-sync-map-table menu-blue-bg" width="100%">
									...
									<tr id="sc_tx_row_<?php echo $rates['tax_rate_id'];?>" class="crs_tr" style="display:none;">
										<td>+&nbsp;</td>
										<td>
