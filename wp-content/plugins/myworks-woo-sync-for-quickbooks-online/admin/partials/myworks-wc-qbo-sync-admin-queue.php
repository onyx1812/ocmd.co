...
<!--  <div style="padding:10px;"><?php _e( 'Current Datetime', 'mw_wc_qbo_sync' );?>: <?php echo $MSQS_QL->now('Y-m-d H:i:s');?></div> -->
 ...
 $mw_wc_qbo_sync_queue_cron_interval_time = $MSQS_QL->get_option('mw_wc_qbo_sync_queue_cron_interval_time');
 $ncrt_int = 10;
 if($mw_wc_qbo_sync_queue_cron_interval_time=='MWQBO_30min'){
	$ncrt_int = 30;
 }
 if($mw_wc_qbo_sync_queue_cron_interval_time=='MWQBO_60min'){
	$ncrt_int = 60;
 }
