...
class WFOCU_Gateway_Integration_Braintree_PayPal extends WFOCU_Gateway {
	...
	public function __construct() {
		...
		add_action( 'wc_payment_gateway_' . $this->get_key() . '_add_transaction_data', array( $this, 'maybe_collect_response_paypal' ), 10, 3 );
	 ...
	 *
	 */
	public function maybe_collect_response_paypal( $order, $response, $direct_API ) {
