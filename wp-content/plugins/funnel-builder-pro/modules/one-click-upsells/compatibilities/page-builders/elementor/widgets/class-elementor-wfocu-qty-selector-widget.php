		...
		if ( true === $qty_selector_enabled ) {
			...
			$this->add_responsive_control( 'qty_dropdown_width', [
				...
				'selectors'  => [
					...
					'body[data-elementor-device-mode="mobile"] {{WRAPPER}}.elementor-mobile-align-center .wfocu-prod-qty-wrapper label, body[data-elementor-device-mode="tablet"] {{WRAPPER}}.elementor-tablet-align-center .wfocu-prod-qty-wrapper label, body[data-elementor-device-mode="desktop"] {{WRAPPER}}.elementor-align-center .wfocu-prod-qty-wrapper label' => 'width: {{SIZE}}{{UNIT}}; font-weight: 300; margin: auto; text-align: left;', '{{WRAPPER}} .wfocu-prod-qty-wrapper > label' => 'width: {{SIZE}}{{UNIT}};display: inline-block;text-align: left;', '{{WRAPPER}} .wfocu-prod-qty-wrapper > span' => 'display:block', '{{WRAPPER}} .wfocu-prod-qty-wrapper .wfocu-select-qty-input, {{WRAPPER}} .wfocu-prod-qty-wrapper .wfocu-select-qty-input option' => 'font-weight: 300; color: #333; box-shadow: none; -webkit-box-shadow: none; -moz-box-shadow: none; font-family: "Open Sans",sans-serif;',
