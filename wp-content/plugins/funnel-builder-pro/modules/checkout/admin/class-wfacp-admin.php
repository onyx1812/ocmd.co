...
final class WFACP_admin {
	...
	private function get_page_design() {
		...
		if ( ! ( class_exists( 'WFFN_Core' ) && isset( $_GET['wffn_funnel_ref'] ) ) ) {
		...
		if ( $id > 0 ) {
            ...
            <script id="wfacp-back-button-template" type="text/html">
                <div id="wfacp-switch-mode">
                    <a id="elementor-back-button" class="button button-default button-large" href="<?php echo esc_url( $edit_link ); ?>">
