    ...
    <div class="wfacp_form_templates_outer" v-if="'yes'==template_active">
        ...
        <div class="wfacp_template_bottom wfacp_temp_link_bottom_wrap">
            ...
            <div class="wfacp_edit_post_links">
                <a class="wfacp_link wfacp_blue_link" target="_blank" href=" <?php echo admin_url( 'post.php?post=' . $wfacp_id . '&action=edit' ); ?>"><span class="dashicons dashicons-wordpress"></span> <?php _e( 'Switch to Editor', 'woofunnels-aero-checkout' ) ?></a>
            </div>
