...
class WFACP_Divi_Summary extends WFACP_Divi_HTML_BLOCK {
	...
	protected function mini_cart() {
		...
		$this->add_switcher( $product_tab_id, 'enable_quantity_box', __( 'Quantity Switcher', 'woofunnels-aero-checkout' ), 'off' );
		$this->add_switcher( $product_tab_id, 'enable_delete_item', __( 'Allow Deletion', 'woofunnels-aero-checkout' ), 'off' );
