...
abstract class WFACP_Divi_HTML_BLOCK extends WFACP_Divi_Field {
	...
	protected function product_switching( $field_key ) {
		...
		$this->add_heading( $tab_id, __( 'Saving Text', 'woofunnels-aero-checkout' ) );
		$saveTextColorOption = [
			'%%order_class%% #wfacp-e-form .wfacp_main_form.woocommerce .wfacp-product-switch-panel fieldset .wfacp_you_save_text',
			'%%order_class%% #wfacp-e-form .wfacp_main_form.woocommerce #wfacp-e-form .wfacp_main_form .wfacp_row_wrap .wfacp_you_save_text span',
			'%%order_class%% #wfacp-e-form .wfacp_main_form.woocommerce .wfacp_row_wrap .wfacp_you_save_text span',
			...
			'%%order_class%% #wfacp-e-form .wfacp_main_form #product_switching_field .wfacp_product_switcher_col_2 .wfacp_product_subs_details lebel',
			'%%order_class%% #wfacp-e-form .wfacp_main_form #product_switching_field .wfacp_product_switcher_col_2 .wfacp_product_subs_details span:not(.subscription-details):not(.woocommerce-Price-amount):not(.woocommerce-Price-currencySymbol)'
		];
		$font_side_default   = [ 'default' => '14px', 'unit' => 'px' ];
		$typography          = [
		...
		$this->add_typography( $tab_id, $field_key . '_you_save_typo', implode( ',', $typography ), '', '', [], $font_side_default );
		$this->add_color( $tab_id, $field_key . '_you_save_color', $saveTextColorOption, '', '#b22323' );
