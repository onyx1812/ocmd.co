...
class El_WFACP_Form_Widget extends WFACP_Elementor_HTML_BLOCK {
	...
	private function global_typography() {
		...
		$default_link_color_option = [
			...
			'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce a:not(.wfacp_close_icon):not(.button-social-login):not(.wfob_btn_add):not(.ywcmas_shipping_address_button_new):not(.wfob_qv-button):not(.wfob_read_more_link)',
