...
class El_WFACP_Form_Products extends WFACP_Elementor_HTML_BLOCK {
	...
	protected function selected_item() {
		...
		$this->add_typography( 'price_typo', '{{WRAPPER}} .shop_table.wfacp-product-switch-panel .wfacp-selected-product .product-price span.woocommerce-Price-amount.amount, {{WRAPPER}} .shop_table.wfacp-product-switch-panel .wfacp-selected-product .product-price span.woocommerce-Price-amount.amount bdi' );
	...
	protected function optional_item() {
		...
		$this->add_typography( 'optional_price_typo', '{{WRAPPER}} .shop_table.wfacp-product-switch-panel .product-price span.woocommerce-Price-amount.amount,{{WRAPPER}} .shop_table.wfacp-product-switch-panel .product-price span.woocommerce-Price-amount.amount bdi' );
